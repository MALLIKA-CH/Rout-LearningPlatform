...
function newpost()
{
	...
	for(var i=0;i<10;i++)
	{
		...
		img.src="./resources/images/other_profile.png";
		...
		span5.className="noofcomment";
		span5.id="comment"+incre;
		var spantext2=document.createTextNode("0 ");
		span5.appendChild(spantext2);
		var text6=document.createTextNode(" comments ");
		para3.appendChild(span5);
		...
		span6.className="fa fa-comments";
		span6.id="comments"+incre;
		...
		div4.appendChild(para4);
		/*^^^^^^^^^^ Span6 onclick code and append ^^^^^^^^^^*/
		var fun3="comments"+"("+"'"+span1.id+"'"+","+"'"+span2.id+"'"+","+"'"+span3.id+"'"+","+"'"+span4.id+"'"+");";
		span6.setAttribute("onclick",fun3);
		para4.appendChild(span6);
		div4.appendChild(para4);
		/*############## Appending DIV4 ############*/
...
function mypost()
{
	...
	var para=document.createElement("p");
	para.className="name";
	var text1=document.createTextNode("Krishna Mallika Cheerala");
	para.appendChild(text1);
	div2.appendChild(para);
	div.appendChild(div2);
